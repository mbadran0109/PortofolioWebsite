...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // ==========================================================================
  // 2. Scroll Animation Observers (Fade-up & Cards)
  // ==========================================================================
  ...
  // ==========================================================================
  // 3. Interactive Service Cards (Collapse/Expand)
  // ==========================================================================
  ...
  toggleButtons.forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      if (isOpen) {
        ...
        body.offsetHeight; // Force a DOM reflow
  ...
  // Delegated click listener for "More" buttons
  ...
  async function ensureEmailJS() {
    if (!window.emailjs) await loadScript(EMAILJS_CDN);
